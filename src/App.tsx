...
import MultiAppDemo from "./pages/multi-apps-demo";
  ...
  return (
    <Router>
      <div className="flex h-screen overflow-hidden bg-[#0E1117]">
        ...
        />
        <div className={`w-full h-screen ${sidebarCollapsed ? "ml-10" : "ml-57"}`}>
          <Routes>
            <Route path="/" index element={<Home />} />
            <Route
              path="/apps"
              element={<AppsLayout sidebarCollapsed={sidebarCollapsed} />}
            >
